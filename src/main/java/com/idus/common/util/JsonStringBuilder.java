...
public class JsonStringBuilder {
	 ...
	 * 
	 * 이 메소드는 DTO의 instance를 json string 형태로 serialize 하는데 사용 됩니다. 이 메소드를 호출하면 아래와
	 * 같은 형태의 엔트리가 추가 됩니다.
	 * 
	 ...
	 * 
	 * 이 메소드는 Integer, Boolean, String, LocalDateTime, List object를 serialize하는데
	 * 사용됩니다. List object의 경우, 내부에서 다른 형태로 overload된 addEntry 메소드가 호출됩니다.
	 * 
	 * 이 메소드를 호출하면 아래와 같은 형태의 엔트리가 추가 됩니다.
	 * 
	 * - 1) list가 아닐경우 : "key":value - 2) list일 경우 : "key":[ {.......}, {.......},
	 * ...... , {......} ]
	 * 
	 * @param key    : JSON object의 key
	 ...
	 * 
	 * 이 메소드는 DTO 객체가 담긴 List를 serialize하는데 사용됩니다. 이 메소드를 호출하면 아래와 같은 형태의 엔트리가 추가
	 * 됩니다.
	 * 
	 * - 2) "key":[ {.......}, {.......}, ...... , {......} ]
	 * 
	 ...
	 * 
	 * JSONStringBuilder객체에 담긴 내용을 String으로 반환합니다. 이 메소드가 한번 호출 되면 해당
	 * JsonStringbuilder 객체는 JsonString으로서의 기능을 잃게 됩니다. 즉 한번 이상 호출 할 수 없습니다.
	 * 
	 */
	@Override
	public String toString() {
